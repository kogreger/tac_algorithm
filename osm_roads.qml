...
<qgis version="2.4.0-Chugiak" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="tac_class" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="1" label="minor"/>
      <category symbol="1" value="2" label="residential"/>
      <category symbol="2" value="3" label="tertiary"/>
      <category symbol="3" value="4" label="secondary"/>
      <category symbol="4" value="5" label="primary"/>
      <category symbol="5" value="6" label="trunk"/>
      <category symbol="6" value="7" label="motorway"/>
    </categories>
    <symbols>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" name="osm_highway"/>
    <edittype labelontop="0" editable="1" name="osm_name"/>
    <edittype labelontop="0" editable="1" name="tac_class"/>
  </edittypes>
  <editform>.</editform>
